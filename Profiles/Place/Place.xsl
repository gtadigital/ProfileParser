    ...
    <xsl:template match="pr:objects/pr:pl">
        <entry>
            ...
            <plParthood_currentPartOf>
                <xsl:value-of
                        select="pr:_nested__pl__pl_ph_current_partof_place_manual/pr:pl__pl_ph_current_partof_place_manual/pr:pl_ph_current_partof_place_manual_place/pr:pl/pr:_uuid"/>
            </plParthood_currentPartOf>
            <plSubstance_geoWKT>
